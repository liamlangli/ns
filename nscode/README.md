...
- **`dynamic/`** — a 3D test bench for the `dynamic` built-in module: convex
  bodies stepped through broad phase, narrow phase (GJK/EPA), constraint solve
  and integration, drawn with the `gpu` module. See `dynamic/README.md`.
