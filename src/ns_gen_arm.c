...
void ns_code_gen_write_type(ns_code_gen_ctx_t *ctx, ns_token_t t) {
    ...
    if (ns_str_equals_STR(t.val, "i64") || ns_str_equals_STR(t.val, "i32") || ns_str_equals_STR(t.val, "i16") ||
        ns_str_equals_STR(t.val, "i8") || ns_str_equals_STR(t.val, "u64") || ns_str_equals_STR(t.val, "u32") ||
        ns_str_equals_STR(t.val, "u16") || ns_str_equals_STR(t.val, "u8") || ns_str_equals_STR(t.val, "f64") ||
