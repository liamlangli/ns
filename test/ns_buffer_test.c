...
int main() {
    ...
    ns_expect(ns_str_equals_STR(ns_str_cstr("gpu_texture_create"), "gpu_texture_create") &&
                  !ns_str_equals_STR(ns_str_cstr("gpu_texture_create_extra"), "gpu_texture_create"),
