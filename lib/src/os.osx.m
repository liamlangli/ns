...
typedef void(*os_on_launch)(os_window*);
typedef void(*os_on_frame)(os_window*);
typedef void(*os_on_terminate)(os_window*);
...
- (void)flagsChanged:(NSEvent*)event {
    ...
    ns_bool command_pressed = os_window_is_key_pressed(&_window, KEY_LEFT_SUPER);
    ns_bool control_pressed = os_window_is_key_pressed(&_window, KEY_LEFT_CONTROL);
    ns_bool shift_pressed = os_window_is_key_pressed(&_window, KEY_LEFT_SHIFT);
    ns_bool alt_pressed = os_window_is_key_pressed(&_window, KEY_LEFT_ALT);
